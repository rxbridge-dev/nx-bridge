...
cmd(
  ...
  async (ranuxPro, mek, m, { from, quoted, q, reply, pushname }) => {
    try {
      ...
      if (m?.type === "imageMessage" || isQuotedImage) {
        ...
        await ranuxPro.sendMessage(from, { sticker: buf }, { quoted: mek });
      ...
      console.error("❌ ranuxPro-MD Sticker Error:", e);
